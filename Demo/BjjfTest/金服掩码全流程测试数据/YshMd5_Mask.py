...
class MaskFull(object):
    ...
    def randomize_enum_values(self):
        ...
        self.params['highestEducation'] = random.choice([6])
    ...
    def InitializationRequest(self,ctype):
        match ctype:
            ...
            case 2:
                self.Domain_name = 'https://bjjfuat.hzbxhd.com/prod-api'
                self.channelSignature = 'BQnoLXEDNVHcXINHqWoYu37aqhMV2mytV33cqoUGmD'
            case 3:
    ...
    def getEncryptionData(self):
        ...
        encrypted_data = AesUtil.encrypt_cbc(params_json, "b81281e4813a174a", iv)
        # 组成JSON返回
        result = {
            'iv': iv,
            'data': encrypted_data
...
if __name__ == '__main__':
    maskFull = MaskFull('154' + str(random.randint(10000000, 99999999)),'杭州','3101')
    maskFull.InitializationRequest(1)
